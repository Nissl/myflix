  ...
  describe "#subscribe_user" do
    ...
    context "card is valid" do
      ...
      it "creates a new user" do
        ...
        UserRegistration.new(alice).subscribe_user({stripeToken: "123"})
      ...
      it "makes the user follow the inviter, if invited" do
        ...
        invitation = Fabricate(:invitation,
                               ...
                               inviter_id: alice.id)
        UserRegistration.new(bob).subscribe_user({invitation_token: invitation.token, 
                                                  stripeToken: "123"})
    ...
    context "card is not valid" do
      ...
      it "sets an error message" do
        alice = Fabricate.build(:user)
        registration = UserRegistration.new(alice).subscribe_user({stripeToken: "123"})
